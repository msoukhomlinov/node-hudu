...
export interface Expiration {
  ...
  asset_layout_field_id: number; // The asset layout field ID associated with the expiration (if any), Can be null.
  sync_id: number; // The sync ID associated with the expiration (if any). Can be null
  archived_at: string; // The timestamp when the expiration was archived (if any). Can be null.
  ...
  asset_field_id: number; // The asset field ID associated with the expiration (if any). Can be null.
}
