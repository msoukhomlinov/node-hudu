...
/** Compact projections (policy §9). They never drop `id`/`name`, the fields a caller resolves by. */
...
/** Never carries `password` or `otp_secret`; those fields are dropped, not empty. */
