...
export interface LabelType {
  ...
  applicable_record_types: "Article" | "Asset" | "AssetPassword" | "Website" | "IpAddress" | "Vlan" | "VlanZone" | "Procedure" | "Network" | "RackStorage"[]; // The record types this label type may be applied to.
